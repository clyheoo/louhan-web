...
<head>
    ...
    <style>
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .detail-table th, .detail-table td { border: 1px solid var(--border); padding: 10px; text-align: left; }
        ...
        .warning-overlay.show .warning-card {
        ...
        .warning-icon {
            ...
            margin: 0 auto 16px; box-shadow: 0 10px 15px -3px rgba(245, 158, 11, 0.3);
        ...
        /* Animasi stagger: muncul satu per satu */
        ...
        .btn-close-warning {
            ...
            background: #d97706; color: white; font-family: inherit; font-size: 14px;
...
.popup-card {
    background: white; border-radius: 24px; padding: 48px 40px 36px;
        ...
        <div class="card">
            <div class="card-header">
                <div>
                    ...
                    <div style="font-size: 11px; color: var(--text-light);">Isi semua kategori, sistem akan memvalidasi batas nilai otomatis.</div>
                </div>
            </div>
            <div class="card-body">
                <div class="form-row">
        ...
        <div class="card">
            ...
            <div class="card-body" style="padding: 0;">
                <table class="result-table">
                    ...
                    <tbody id="tbody-scores"><tr><td colspan="6"><div class="empty-state" style="padding:30px;">Belum ada data.</div></td></tr></tbody>
                </table>
            </div>
        </div>
    </div>
    ...
    <div class="warning-overlay" id="warningModal">
        <div class="warning-card">
            ...
            <div class="warning-body">
                <ul class="error-list" id="errorListContainer">
...
function submitAllScores() {
    ...
    .then(function(d) {
        if(d.success) {
            const title = isEditing ? 'Nilai Berhasil Diperbarui!' : 'Nilai Berhasil Disimpan!';
            const desc  = 'Total nilai seluruh kategori: <strong style="color:#2563eb; font-size:18px;">' + grandTotal + '</strong>';
            ...
            document.getElementById('btnSaveAll').innerHTML = '<i class="fas fa-paper-plane"></i> SIMPAN SELURUH NILAI';
            changeKat('overall'); 
            loadJuriData(); 
    ...
    .finally(function() { 
        btn.disabled = false; 
        btn.innerHTML = isEditing ? '<i class="fas fa-pen-to-square"></i> PERBAUI NILAI' : '<i class="fas fa-paper-plane"></i> SIMPAN SELURUH NILAI'; 
    });
}
...
function loadJuriData() {
    ...
    .then(function(data) {
        ...
        if(!data.my_scores || data.my_scores.length === 0) {
            tbody.innerHTML = '<tr><td colspan="6"><div class="empty-state" style="padding:30px;">Belum ada data penilaian.</div></td></tr>';
            return;
        }
...
function showWarningModal(errorsArray) {
    ...
    errorsArray.forEach(function(err) {
        ...
        else if(err.type === 'checkbox' || err.type === 'select') { iconClass = 'fas fa-hand-pointer'; errTitle = 'Aksi Belum Dilakukan'; }
