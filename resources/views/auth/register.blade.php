...
<head>
    ...
    <style>
        ...
        *, *::before, *::after {
        ...
        .form-group {
            margin-bottom: 14px;
            animation: textFadeIn 0.6s 0.32s both;
        }
        ...
        .form-input.input-error ~ i.input-icon { color: var(--red-500); }
        .form-input.input-success {
            border-color: var(--green-500);
            box-shadow: 0 0 0 3px rgba(34,197,94,0.1);
        }
        .form-input.input-success ~ i.input-icon { color: var(--green-500); }
        ...
        .input-error-msg i { font-size: 10px; }

        /* Password toggle - diperbaiki z-index */
        .password-toggle {
            position: absolute;
            right: 12px;
            top: 50%;
        ...
        .strength-segment.active-weak { background: var(--red-500); }
        .strength-segment.active-medium { background: #f59e0b; }
        .strength-segment.active-strong { background: var(--green-500); }
        ...
        .match-indicator.matched { color: var(--green-500); }
        .match-indicator.not-matched { color: var(--red-500); }
        ...
        .divider {
            ...
            gap: 14px;
            margin-bottom: 20px;
            animation: textFadeIn 0.6s 0.46s both;
        }
        .divider-line {
            flex: 1;
            height: 1px;
        ...
        .features {
            ...
            gap: 8px;
            margin-top: 20px;
            animation: textFadeIn 0.6s 0.52s both;
        }
        .feature-item {
            display: flex;
        ...
        .login-footer {
            margin-top: 24px;
            text-align: center;
            animation: textFadeIn 0.6s 0.56s both;
        }
        .footer-divider {
            width: 40px;
            height: 2px;
        ...
        @media (max-width: 480px) {
            ...
            .popup-card { padding: 40px 28px 28px; }
        }
...
<body>
    ...
    <main class="login-wrapper">
        <div class="login-card">
            ...
            <p class="login-subtitle">Daftar untuk mengakses seluruh fitur<br>LCI Suite</p>
            ...
            <form method="POST" action="{{ route('register') }}" id="registerForm">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <input type="text" name="name" id="name" class="form-input" placeholder="Masukkan nama lengkap" value="{{ old('name') }}" required autofocus>
                        <i class="fas fa-user input-icon"></i>
                    </div>
                </div>
                <div id="emailError" class="input-error-msg" style="display:none">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <input type="password" name="password" id="password" class="form-input" placeholder="Min.8: besar, kecil, angka, simbol" required>
                        <i class="fas fa-lock input-icon"></i>
                        <button type="button" class="password-toggle" id="togglePwd1">
                            <i class="fas fa-eye"></i>
                        </button>
                    </div>
                    <div id="passwordError" class="input-error-msg" style="display:none">
                        <i class="fas fa-circle-exclamation"></i>
                        <span>Wajib: min.8 karakter, huruf besar, kecil, angka, simbol</span>
                    </div>
                    <div class="strength-bar-container" id="strengthBar" style="display:none">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <i class="fas fa-lock input-icon"></i>
                        <button type="button" class="password-toggle" id="togglePwd2">
                            <i class="fas fa-eye"></i>
                        </button>
                    </div>
                    <div id="matchError" class="match-indicator not-matched" style="display:none">
                        <i class="fas fa-circle-exclamation"></i>
                        <span>Password tidak cocok</span>
                    </div>
                    <div id="matchSuccess" class="match-indicator matched" style="display:none">
    ...
    <div class="popup-overlay" id="successPopup">
        <div class="popup-card">
            ...
            <h2 class="popup-title">Berhasil Mendaftar!</h2>
            <p class="popup-desc">Akun kamu sudah dibuat. Silakan masuk dengan email dan password yang baru saja didaftarkan.</p>
...
function validatePassword(){
    ...
    var barEl   = document.getElementById('strengthBar');
    ...
    for(var s = 0; s < segments.length; s++) segments[s].className = 'strength-segment';
    ...
    if(val.length < 8 || !hasLower || !hasUpper || !hasNumber || !hasSymbol){
        errorEl.style.display = 'flex';
        passwordInput.classList.add('input-error');
        passwordInput.classList.remove('input-success');
        textEl.textContent = 'Belum memenuhi syarat';
        textEl.classList.add('weak');
        if(strength > 0) segments[0].classList.add('active-weak');
    } else {
        errorEl.style.display = 'none';
        passwordInput.classList.remove('input-error');
        passwordInput.classList.add('input-success');
        if(strength <= 3){
            for(var a = 0; a < 2; a++) segments[a].classList.add('active-medium');
            textEl.textContent = 'Cukup';
            textEl.classList.add('medium');
            passwordInput.classList.remove('input-success');
        } else if(strength === 4){
            for(var b = 0; b < 4; b++) segments[b].classList.add('active-strong');
            textEl.textContent = 'Kuat';
            textEl.classList.add('strong');
        } else {
            for(var c = 0; c < 5; c++) segments[c].classList.add('active-strong');
    ...
    .then(function(data){
        if(data._isError){
            ...
            if(data.errors.email){
                ...
                emailErr.querySelector('span').textContent = data.errors.email[0];
                emailErr.style.display = 'flex';
            }
            if(data.errors.password){
                document.getElementById('passwordError').style.display = 'flex';
                document.getElementById('passwordError').querySelector('span').textContent = data.errors.password[0];
                passwordInput.classList.add('input-error');
            }
            return;
        }
